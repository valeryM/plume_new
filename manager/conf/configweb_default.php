...
$_PX_website_config['document_root'] = '/plume';

$_PX_website_config['xmedia_root'] = '/plume/xmedia';

/* for example '127.0.0.1' if you have 'http://127.0.0.1/plume' */
$_PX_website_config['domain'] = 'localhost';
...
$_PX_website_config['comment_support'] = 3;
...
$_PX_config['email_for_sending_notification'] = 'webmaster@monsite.fr';
