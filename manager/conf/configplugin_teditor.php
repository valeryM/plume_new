...
// Fichier de configuration du plugin d'edition de gabarit

$_PX_pconfig['edition_height'] = '25';
$_PX_pconfig['edition_style']['width'] = '100%';
$_PX_pconfig['edition_style']['color'] = 'black';
$_PX_pconfig['edition_style']['background'] = '#E7E7E7';
