...
class Sitemap
{
    ...
    public static function action($query)
    {
        ...
        $category_id = '';
        //$path = Sitemap::parseQueryString($query);
        //if ($path != '/') {
            $sql = SQL::getCategoryByPath('/', config::f('website_id'));
            $con =& pxDBConnect();
