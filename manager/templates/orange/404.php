...
<div id="page">
     ...
     <div id="col-content-head"></div>
          ...
          <div class="menuright_head"></div>
             ...
             <div id="research"></div>
             <h2 class="err404"><?php echo __('Error 404') ?></h2>
             <?php echo __('<p>The page you are looking for is not available anymore. We tried to search for the pages that match your request.</p><p class="modified">Feel free to refine the search.</p>') ?>
